...
CUDA_VISIBLE_DEVICES=5 python train_other.py \
    --root_dir ./data/scannet/scene0046_00 --dataset_type scannet --dataset_name scannet --exp_name mega_size2 \
...
CUDA_VISIBLE_DEVICES=2 python train_other.py \
    --root_dir ./data/scannet/scene0276_00 --dataset_type scannet --dataset_name scannet --exp_name mega_size2 \
...
CUDA_VISIBLE_DEVICES=3 python train_other.py \
    --root_dir ./data/scannet/scene0515_00 --dataset_type scannet --dataset_name scannet --exp_name mega_size2 \
...
CUDA_VISIBLE_DEVICES=4 python train_other.py \
    --root_dir ./data/scannet/scene0673_04 --dataset_type scannet --dataset_name scannet --exp_name mega_size2 \
