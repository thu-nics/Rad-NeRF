...
CUDA_VISIBLE_DEVICES=1 python train_other.py \
    --root_dir ./data/360_v2/bicycle --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
...
CUDA_VISIBLE_DEVICES=2 python train_other.py \
    --root_dir ./data/360_v2/bonsai --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
...
CUDA_VISIBLE_DEVICES=3 python train_other.py \
    --root_dir ./data/360_v2/counter --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
...
CUDA_VISIBLE_DEVICES=4 python train_other.py \
    --root_dir ./data/360_v2/garden --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
...
CUDA_VISIBLE_DEVICES=5 python train_other.py \
    --root_dir ./data/360_v2/kitchen --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
...
CUDA_VISIBLE_DEVICES=6 python train_other.py \
    --root_dir ./data/360_v2/room --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
...
CUDA_VISIBLE_DEVICES=7 python train_other.py \
    --root_dir ./data/360_v2/stump --dataset_type colmap --dataset_name 360_v2 --exp_name block_size2 \
